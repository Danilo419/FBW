...
/* ============================================================
   ...
   - remove "madrid" genérico => não pode virar Real Madrid
   - nunca inventa "Shadow", "Samurai", cores, etc.
   - se não der para inferir com segurança => não mostra label
============================================================ */
...
/* ============================================================
   Filtro: RETRO jerseys (qualquer sleeve), exclui kits/sets
============================================================ */
...
function isRetroJersey(p: UIProduct): boolean {
  const n = normName(p);
  if (!n) return false;
