...
import { leaguesOrder, clubImg, type LeagueKey } from "../../lib/shop-data";

/* ---------------- Players (apenas para UI da página) ---------------- */
const players = [
...
/* Clubs em destaque -> navega para /products/team/[club] */
...
export default function ProductsClient() {
  ...
  return (
    <div className="container-fw py-16">
      <h1 className="text-3xl sm:text-4xl font-extrabold mb-12 text-center">Browse Products</h1>
