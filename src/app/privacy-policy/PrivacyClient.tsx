...
export default function PrivacyClient() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="container-fw pt-20 md:pt-28 pb-24">
        {/* ======= HERO ======= */}
          ...
          <div className="grid gap-6">
            ...
            >
              <p>
                ...
                your information when you visit our website, create an account,
                place an order, or contact support. By using our services you
            ...
            >
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  ...
                  address, phone (optional), order details, personalization
                  choices.
                </li>
                <li>
                ...
                <li>
                  <strong>Support messages:</strong> content you send via
                  forms/email, plus metadata (time, IP, browser info).
                </li>
                <li>
                  <strong>Usage data:</strong> pages viewed, clicks,
                  device/browser, approximate location, referrer (via
                  cookies/analytics).
                </li>
                <li>
                  <strong>Cookies:</strong> essential for cart/session and
                  optional analytics/marketing cookies (see Cookies section).
                </li>
              </ul>
            </PolicyCard>
            ...
            >
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <strong>Contract:</strong> fulfilling purchases and providing
                  services.
                </li>
                <li>
                  <strong>Legitimate interests:</strong> security, fraud
                  prevention, improving services.
                </li>
                <li>
                  <strong>Consent:</strong> optional analytics/marketing and
                  some communications.
                </li>
                <li>
            ...
            >
              <p>
                We share data with trusted providers who help operate our
                business:
              </p>
              <ul className="mt-2 list-disc pl-5 space-y-1">
                ...
                <li>
                  <strong>Shipping & logistics:</strong> carriers and tracking
                  services.
                </li>
                <li>
                  <strong>Analytics:</strong> privacy-friendly tools and/or
                  major analytics (lawfully configured).
                </li>
                <li>
              ...
              <p className="mt-2">
                We require processors to handle data only on our instructions
                and protect it appropriately. We do not sell your personal data.
              </p>
            </PolicyCard>
            ...
            >
              <p>
                Payments are handled by third-party processors. We never store
                your full card details on our servers. Refer to your selected
                provider’s privacy policy for more details.
              </p>
            </PolicyCard>
            ...
            >
              <p>
                For delivery, we share necessary information (name, address,
                phone, order contents) with shipping partners for parcel
                creation and tracking. See our{" "}
                <Link
            ...
            >
              <p>
                We use essential cookies for core features (cart, session). With
                consent where required, we may use analytics/marketing cookies
                to understand usage and improve the site.
              </p>
              <ul className="mt-2 list-disc pl-5 space-y-1">
                <li>
                  <strong>Essential:</strong> strictly necessary; cannot be
                  switched off.
                </li>
                <li>
                  <strong>Analytics:</strong> help measure and improve
                  performance.
                </li>
                <li>
                  <strong>Marketing:</strong> optional; used to show relevant
                  offers.
                </li>
              </ul>
            </PolicyCard>
            ...
            >
              <p>
                We keep personal data only as long as necessary for purposes
                described in this policy, including legal, accounting, or
                reporting requirements. Retention periods vary by data type and
                legal obligations.
              </p>
            </PolicyCard>
            ...
            >
              <p>
                ...
                to protect your data. However, no method of transmission or
            ...
            >
              <p>
                ...
                countries outside your own. Where required, we implement
            ...
            >
              <p>
                ...
                by applicable law. We do not knowingly collect data from
            ...
            >
              ...
              <p className="mt-3 text-xs text-gray-500">
                This page is provided for transparency and does not constitute
                legal advice.
              </p>
            </PolicyCard>
          </div>
...
function PolicyCard({
  ...
  return (
    <section
      ...
      className="card group p-6 sm:p-7 scroll-mt-28"
    >
