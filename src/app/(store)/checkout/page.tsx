...
async function startStripe(method: StripeMethod) {
  const res = await fetch('/api/checkout/stripe', {
    ...
    // Address was already collected in /checkout/address and stored in a cookie
...
export default function CheckoutPage() {
  ...
  // Guard: if there is no shipping cookie, force the user to the address step
  useEffect(() => {
    let alive = true;
    (async () => {
      try {
